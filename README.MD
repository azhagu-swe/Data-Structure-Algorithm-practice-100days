...
**Task:** Given an odd-length string, print it in an "X" pattern, with characters aligned diagonally.  
**Approach:**  
...
**Task:** Find the smallest missing positive integer in an unsorted array.  
**Approach:**  
1. **Mark Visited:**  
...
- **Space:** O(n) — boolean array for tracking.  
**Edge Cases:**  
